...
public static String CaptureScreenSpecific(WebDriver driver,String status, String environment){
	...
	public static String CaptureExcel(WebDriver driver, String status) {
		// TODO Auto-generated method stub
		
		String Path=  "../"+VariableController.getTestCaseName()+"/"+VariableController.getTestCaseName()+"Output.xls";
		return Path;
	}

	public static String CaptureScreenComp(WebDriver driver, String status, String pathDetails) {
		// TODO Auto-generated method stub
		String Path= "../"+VariableController.getTestCaseName()+"/screenshots/"+pathDetails+".png";
		return Path;
	}

	public static String capturePartScreenshot(By by, String path) throws IOException {
		// TODO Auto-generated method stub
		...
		String folderPath =  System.getProperty("user.dir")+"\\output\\"+VariableController.getTestCaseName()+"\\screenshots\\"+path+"Part.png";
		
		try {
			FileUtils.copyFile(f1, new File(folderPath));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		
		}
		String Path = "../"+VariableController.getTestCaseName()+"/screenshots/"+path+"Part.png";
		return Path;
	}
