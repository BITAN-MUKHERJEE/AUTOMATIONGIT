...
public class ListToHtmlTransformer {
	...
	public String renderReport(String tesCaseName, String TCDescription, Date Starttime ,Date Endtime,String Status,String browser , java.util.Collection< String >  tcasestep , java.util.Collection< String >  status , java.util.Collection< String >  description , java.util.Collection< String >  Screenshot , long time){
         ...
         html.append( "<tr>\n" );
         html.append( "<td class='tablecontent' style='text-align: left' width='30%'><b>Test Case Name :</b>"+tesCaseName+"</td>\n" );
         html.append( "<td class='tablecontent' style='text-align: left' width='50%'><b>Test Case Description :</b>"+TCDescription+"</td>\n" );
         html.append( "<td class='tablecontent' style='text-align: left' width='20%'><b>Execution Start Time :</b>"+Starttime.toString()+"</td>\n" );
         html.append( "</tr>\n" );
         html.append( "<tr>\n" );
         ...
         for (int i = 0; i < tcasestep.size(); i++) {
            ...
            // html.append( "<td class= 'tablecontent' align='center' width='15%'><a target=blank() href='"+Screenshot.toArray()[i]+"' >Screenshot</a></td>\n" );
             ...
             if(screenshotFlag.contains("None")){
     			
            	 
                 html.append( "<td class= 'tablecontent' align='center' width='15%'><a target=blank() href='"+""+"' > </a></td>\n" );

     			
     		}
     		else if(screenshotFlag.contains("All")){
    			...
    			if(status.toArray()[i].equals("Fail")){
    				
                    html.append( "<td class= 'tablecontent' align='center' width='15%'><a target=blank() href='"+Screenshot.toArray()[i]+"' >Screenshot</a></td>\n" );

    				
    				}
    			else if (status.toArray()[i].equals("Pass")){
         ...
         html.append( "</tr>\n" );
         html.append( "<tr>\n" );
         html.append( "<td class='footer'>Copyright &copy 2013-2018 Tata Consultancy Services Ltd.</td>\n" );
         html.append( "</tr>\n" );
         html.append( "</table>\n" );
         html.append( "</body>\n" );
         html.append( "</html>\n" );
