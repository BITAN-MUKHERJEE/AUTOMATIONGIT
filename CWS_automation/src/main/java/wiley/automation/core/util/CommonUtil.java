...
public static void declareVariables() throws WriteException
{
	 ...
	 List<String> WIP_Amount_Americas_Online = new ArrayList<String>();
	 List<String> WIP_Amount_UK_Online = new ArrayList<String>();
	 List<String> WIP_Amount_Europe_Online = new ArrayList<String>();
	 List<String> WIP_Amount_ROW_Online = new ArrayList<String>();
	 List<String> WIP_SAP_ISSN_Online = new ArrayList<String>();
	 List<String> WIP_Amount_Americas_Print_Online = new ArrayList<String>();
	 List<String> WIP_Amount_UK_Print_Online = new ArrayList<String>();
	 List<String> WIP_Amount_Europe_Print_Online = new ArrayList<String>();
	 List<String> WIP_Amount_ROW_Print_Online = new ArrayList<String>();
	 List<String> WIP_SAP_ISSN_Print_Online = new ArrayList<String>();
	 List<String> WIP_Amount_Americas_Print = new ArrayList<String>();
	 List<String> WIP_Amount_UK_Print = new ArrayList<String>();
	 List<String> WIP_Amount_Europe_Print = new ArrayList<String>();
	 List<String> WIP_Amount_ROW_Print = new ArrayList<String>();
	 List<String> WIP_SAP_ISSN_Print = new ArrayList<String>();
	 ...
	 List<String> UAT_Amount_Americas_Online = new ArrayList<String>();
	 List<String> UAT_Amount_UK_Online = new ArrayList<String>();
	 List<String> UAT_Amount_Europe_Online = new ArrayList<String>();
	 List<String> UAT_Amount_ROW_Online = new ArrayList<String>();
	 List<String> UAT_SAP_ISSN_Online = new ArrayList<String>();
	 List<String> UAT_Amount_Americas_Print_Online = new ArrayList<String>();
	 List<String> UAT_Amount_UK_Print_Online = new ArrayList<String>();
	 List<String> UAT_Amount_Europe_Print_Online = new ArrayList<String>();
	 List<String> UAT_Amount_ROW_Print_Online = new ArrayList<String>();
	 List<String> UAT_SAP_ISSN_Print_Online = new ArrayList<String>();
	 List<String> UAT_Amount_Americas_Print = new ArrayList<String>();
	 List<String> UAT_Amount_UK_Print = new ArrayList<String>();
	 List<String> UAT_Amount_Europe_Print = new ArrayList<String>();
	 List<String> UAT_Amount_ROW_Print = new ArrayList<String>();
	 List<String> UAT_SAP_ISSN_Print = new ArrayList<String>();
	 
	 excelWrite.setValueIntoCell("UATdetails",0,0,"WIP_JOURNAL_NAME");
	 excelWrite.setValueIntoCell("UATdetails",1,0,"UAT_JOURNAL_NAME");
	 excelWrite.setValueIntoCell("UATdetails",2,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",3,0,"WIP_JOURNAL_NAME_ISSN");
	 excelWrite.setValueIntoCell("UATdetails",4,0,"UAT_JOURNAL_NAME_ISSN");
	 excelWrite.setValueIntoCell("UATdetails",5,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",6,0,"WIP_JOURNAL_TYPE");
	 excelWrite.setValueIntoCell("UATdetails",7,0,"UAT_JOURNAL_TYPE");
	 excelWrite.setValueIntoCell("UATdetails",8,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",9,0,"WIP_Amount_Americas_Online");
	 excelWrite.setValueIntoCell("UATdetails",10,0,"UAT_Amount_Americas_Online");
	 excelWrite.setValueIntoCell("UATdetails",11,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",12,0,"WIP_Amount_UK_Online");
	 excelWrite.setValueIntoCell("UATdetails",13,0,"UAT_Amount_UK_Online");
	 excelWrite.setValueIntoCell("UATdetails",14,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",15,0,"WIP_Amount_Europe_Online");
	 excelWrite.setValueIntoCell("UATdetails",16,0,"UAT_Amount_Europe_Online");
	 excelWrite.setValueIntoCell("UATdetails",17,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",18,0,"WIP_Amount_ROW_Online");
	 excelWrite.setValueIntoCell("UATdetails",19,0,"UAT_Amount_ROW_Online");
	 excelWrite.setValueIntoCell("UATdetails",20,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",21,0,"WIP_SAP_ISSN_Online");
	 excelWrite.setValueIntoCell("UATdetails",22,0,"UAT_SAP_ISSN_Online");
	 excelWrite.setValueIntoCell("UATdetails",23,0,"RESULT");
	 
	 excelWrite.setValueIntoCell("UATdetails",24,0,"WIP_Amount_Americas_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",25,0,"UAT_Amount_Americas_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",26,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",27,0,"WIP_Amount_UK_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",28,0,"UAT_Amount_UK_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",29,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",30,0,"WIP_Amount_Europe_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",31,0,"UAT_Amount_Europe_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",32,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",33,0,"WIP_Amount_ROW_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",34,0,"UAT_Amount_ROW_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",35,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",36,0,"WIP_SAP_ISSN_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",37,0,"UAT_SAP_ISSN_Print_Online");
	 excelWrite.setValueIntoCell("UATdetails",38,0,"RESULT");


	 excelWrite.setValueIntoCell("UATdetails",39,0,"WIP_Amount_Americas_Print");
	 excelWrite.setValueIntoCell("UATdetails",40,0,"UAT_Amount_Americas_Print");
	 excelWrite.setValueIntoCell("UATdetails",41,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",42,0,"WIP_Amount_UK_Print");
	 excelWrite.setValueIntoCell("UATdetails",43,0,"UAT_Amount_UK_Print");
	 excelWrite.setValueIntoCell("UATdetails",44,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",45,0,"WIP_Amount_Europe_Print");
	 excelWrite.setValueIntoCell("UATdetails",46,0,"UAT_Amount_Europe_Print");
	 excelWrite.setValueIntoCell("UATdetails",47,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",48,0,"WIP_Amount_ROW_Print");
	 excelWrite.setValueIntoCell("UATdetails",49,0,"UAT_Amount_ROW_Print");
	 excelWrite.setValueIntoCell("UATdetails",50,0,"RESULT");
	 excelWrite.setValueIntoCell("UATdetails",51,0,"WIP_SAP_ISSN_Print");
	 excelWrite.setValueIntoCell("UATdetails",52,0,"UAT_SAP_ISSN_Print");
	 excelWrite.setValueIntoCell("UATdetails",53,0,"RESULT");
}



public static void capturePartScreenshot(By by, String destPath) throws IOException{
...
/*	WebElement html = driver.findElement(By.tagName("html"));
	...
	if(CommonUtil.isElementPresent(by))
	{
	ele = CommonUtil.driver.findElement(by);
	}
	...
	BufferedImage eleScreenshot= fullImg.getSubimage(p.getX(), p.getY(), eleWidth, eleHeight);
	try {
	...
	//File screenshotLocation = new File("C:\\GoogleLogo_screenshot.png");
	//FileUtils.copyFile(screenshot, screenshotLocation);
	String TestcaseName = "ABC";
	
	DateFormat screenshotName1 = new SimpleDateFormat("dd-MMMM-yyyy_HH-mm-ss");
	Date screenshotDate = new Date();
	String picName = screenshotName1.format(screenshotDate);
	File screenshotLocation = new File("C:\\"+picName+".png");*/
	WebElement element=null;
	File f1 = ((TakesScreenshot)CommonUtil.driver).getScreenshotAs(OutputType.FILE);
	element = CommonUtil.driver.findElement(by);
	int ImageWidth = element.getSize().getWidth();
	int ImageHeight = element.getSize().getHeight();

	//org.openqa.selenium.Point point = element.getLocation();
	org.openqa.selenium.Point value=element.getLocation();
	int xcord = value.getX();
	int ycord = value.getY();
	...
	try {
		FileUtils.copyFile(f1, new File("C:\\Users\\apsinha\\Downloads\\b.png"));
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
...
public static void reportexcel(String steps, String status) {
	// TODO Auto-generated method stub
	...
	if(status.equalsIgnoreCase(pass)){
		...
		//log.fatal(steps);
			...
			try{
				...
				ReportUtil.status.add(status);
				ReportUtil.description.add(" ");
				ReportUtil.Screenshot.add(ImageUtil.CaptureExcel(driver,status));
				
			}catch(Exception e){}
		
	}

public static void reportSpecific(String steps, String status, String desc, String environmentFinal) {
	// TODO Auto-generated method stub
	if(status.equalsIgnoreCase(pass)){
		//log.info(steps);
	}else if(status.equalsIgnoreCase(fail)){
		//log.fatal(steps);
			...
			try{
				...
				ReportUtil.status.add(status);
				ReportUtil.description.add(desc);
				ReportUtil.Screenshot.add(ImageUtil.CaptureScreenSpecific(driver,status,environmentFinal));
				
			}catch(Exception e){}
		
	}

public static void reportCmpare(String steps, String status, String desc, String PathDetails) {
	// TODO Auto-generated method stub
	...
	if(status.equalsIgnoreCase(pass)){
		...
		//log.fatal(steps);
			...
			try{
				...
				ReportUtil.status.add(status);
				ReportUtil.description.add(desc);
				ReportUtil.Screenshot.add(ImageUtil.CaptureScreenComp(driver,status,PathDetails));
				
			}catch(Exception e){}
		
	}

public static void reportPartScreenshot(String msg, String status,String journalName, By details,String environmentFinal2) {
	if(status.equalsIgnoreCase(pass)){
		//log.info(steps);
	}else if(status.equalsIgnoreCase(fail)){
		//log.fatal(steps);
			...
			try{
				ReportUtil.tcasestep.add(msg);
				ReportUtil.status.add(status);
				ReportUtil.description.add(journalName);
				//ReportUtil.Screenshot.add(ImageUtil.CaptureScreen(driver));
				ReportUtil.Screenshot.add(ImageUtil.capturePartScreenshot(details,environmentFinal2));
